...
return new Promise(async(resolve,reject)=>{
  await db.get().collection(collection.USER_COLLECTIONS).updateOne({_id:objectId(userId)},{$pull:{oderaddress:{
        orderAddressId:objectId(addressId)}}}).then((response)=>{
